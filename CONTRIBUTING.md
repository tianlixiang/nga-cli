# Contributing to NGA CLI / 贡献指南

Thanks for your interest in NGA CLI! / 感谢你对 NGA CLI 的关注!
...
NGA CLI is distributed under the **GNU Affero General Public License,
...
The NGA CLI name, logo, and related marks are governed by
...
NGA CLI 采用 **GNU Affero General Public License v3 或更高版本
...
NGA CLI 名称、Logo 及相关标识由 [TRADEMARKS.md](TRADEMARKS.md) 管辖,
