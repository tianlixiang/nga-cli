...
// are optional — empty falls through to NGA CLI's built-in default.
//
...
//
// Persisted via Tauri command into ~/.nga-cli/tools.json.
...
const TOOL_DEFAULTS: Record<string, ToolConfigEntry> = {
  ...
  nga: { command: 'nga', extra_args: [], default_cwd: '', history_path: '~/.local/share/opencode' },
...
// Tools whose session history NGA CLI's history scanner actually reads
...
const HISTORY_SCANNED_TOOLS = new Set([
  'claude', 'codex', 'antigravity', 'hermes', 'opencode', 'nga', 'openclaw', 'mimocode',
]);
